    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-xs-12">
        ...
        <div class="box box-success">
          ...
          <form role="form" method="post" class="formularioCotizar">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    if(!$cotizacion){
                      ...
                      echo '<input type="text" class="form-control" id="nuevaVenta" name="nuevaVenta" value="50001" readonly>';
                  ...
                  <div class="cajasMetodoPago">
                       ...
                       <div class="col-xs-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control efectivo" id="nuevoValorEfectivo" placeholder="000000" required readonly="" >
                       ...
                       <div class="col-xs-6" id="capturarCambioEfectivo" style="padding-left:0px">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="nuevoCambioEfectivo" readonly min="0" placeholder="000000" required readonly>
