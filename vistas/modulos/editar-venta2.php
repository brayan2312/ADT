                          ...
                          <td style="width: 50%">
                             ...
                             <label>
                                ...
                                if($venta["pendiente"] == 1){
                                  ...
                                  echo '<input type="checkbox" class="minimal checkbox_2" checked>';

                                }else if($venta["pendiente"] == 0){

                                  echo '<input type="checkbox" class="minimal checkbox_3">';
                                  
                                }

                                 ?>
                               
                                <input type="hidden" id="pendienteEditar" name="pendienteEditar" value="">
                                Entrega pendiente
                              </label>
